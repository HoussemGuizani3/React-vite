...
export const HeroSearch: React.FC<HeroSearchProps> = ({ searchTerm, setSearchTerm }) => {

  const displayValueInput = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <HeroSearchContainer>
      <InputField 
        type="text" 
        text={searchTerm} 
        placeholder="Search by skill, location, or name (e.g: 'React', 'New York')" 
        onChange={displayValueInput} 
      />
