...
import { MyFormLogin } from './MyFormLogin.tsx';
import styled from 'styled-components';
import { Link } from 'react-router-dom';
import { DataLinks, type SocialItem} from '../shared/navigation/DataLinks.tsx';
...
export const LoginRight = () => {
    ...
    return (
        <Formulaire>
            <Title text="Welcome back" size='40px' weight='800' />
            ...
            <AuthSwitchText>
                <TextMuted text="Don't have an account?" size="16px" color="#666666" margin="0" />
